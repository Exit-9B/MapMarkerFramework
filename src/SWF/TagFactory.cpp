...
namespace SWF
{
	...
	auto TagFactory::MakeRemoveObject(AllocateCallback a_alloc, std::uint16_t a_depth)
		-> RE::GFxRemoveObject2*
	{
	...
	auto TagFactory::MakeInitImportActions(AllocateCallback a_alloc, std::uint32_t a_movieIndex)
	...
	auto TagFactory::MakeDoAction(AllocateCallback a_alloc, RE::GASActionBufferData* a_data)
		-> RE::GASDoAction*
	{
